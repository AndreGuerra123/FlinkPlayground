...
public class InnerJoiner implements JoinFunction<Tuple2<String,String>,Tuple2<String,String>,Tuple3<String,String,String>>{
    ...
    public Tuple3<String, String, String> join(Tuple2<String, String> first, Tuple2<String, String> second)
        ...
        return new Tuple3<String,String,String>(first.f0,first.f1,second.f1);
    }
